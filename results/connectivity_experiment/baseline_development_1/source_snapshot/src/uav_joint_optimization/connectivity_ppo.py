"""PPO for the separately versioned strict connectivity study.

Derived transparently from experiment_ppo.py, preserving its PPO estimator and
optimizer. The environment, 61 option network head, and metrics are changed.
"""
...
from .connectivity_env import ConnectivityConfig as EnvironmentConfig, ConnectivityBatch
