...
"""
    ...
    def decode_residual(self, residual):
        base = self.reference_motion()
        base /= np.maximum(np.linalg.norm(base, axis=1, keepdims=True), 1.)
        return base + self.cfg.residual_scale * residual
