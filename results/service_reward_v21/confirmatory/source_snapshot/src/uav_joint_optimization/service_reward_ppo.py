"""Unchanged V2 PPO estimator with the separately versioned service reward adapter."""
...
from .service_reward_env import ServiceRewardConfig as EnvironmentConfig, ServiceRewardBatch as ConnectivityBatch
