...
from run_service_reward_study import BASE, SEEDS, verify_history, verify_new, save, learner, configure_label
...
def main():
    ...
    parser.add_argument('--label',help='Reproduction label used by the runner.')
    args=parser.parse_args(); BASE,_,_=configure_label(args.label)
