...
The source explicitly converts an initial noise value of $-174$ to $-112.41$ dBm \cite[p.~14, Sec.~6.1; p.~15, Table~3]{thesis}. If that conversion were omitted in the plotted calculation, subtracting 61.59 dB would give approximate median SNRs of 62.4/65.4 dB for equal PPO/greedy and 61.4/60.4/61.4 dB for delay/interference/handover policies. Note 57 records native image digitization and a conservative $\pm1$ dB reading allowance. This is a conditional hypothesis, not a recovered actual result: source code and raw figure data remain unavailable. Neither this correction nor superiority over the source policies is established.
...
\begin{figure*}[!t]\centering\includegraphics[width=.97\textwidth]{../results/thesis_metrics_v22/analysis/metric_comparison_longer_test.pdf}
